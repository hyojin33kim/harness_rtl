...
module tb_spw_datalink_semantics;
    ...
    initial begin
        ...
        accept_request();
        if (dut.u_credit.r_tx_credit !== 6'd3)
            $fatal(1, "P6: N-Char ACCEPT changed credit");
        commit_request();
        if (dut.u_credit.r_tx_credit !== 6'd2)
        ...
        accept_request();
        if (dut.u_credit.r_rx_credit !== 6'd0)
            $fatal(1, "P7: FCT ACCEPT changed RX credit");
        commit_request();
        if (dut.u_credit.r_rx_credit !== 6'd8)
        ...
        force dut.u_credit.r_tx_credit = 6'd0;
        force dut.u_credit.r_rx_credit = 6'd0;
        force dut.u_credit.r_req_initial_fct = 3'd1;
        ...
        release dut.u_credit.r_tx_credit;
        release dut.u_credit.r_rx_credit;
        release dut.u_credit.r_req_initial_fct;
